...
output_folder = fr"C:\Users\lenox\tomass\projects\paper_ie\outputsv2\{pdf_name}"
...
def main():
    ...
    user_prompt_temp = load_template(r"source\prompts\ie\user\user_prompt_aims_wBackground.md")
