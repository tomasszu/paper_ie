...
output_folder = fr"C:\Users\lenox\tomass\projects\paper_ie\outputsv3\{pdf_name}"
...
def main():
    ...
    user_prompt_temp = load_template(r"source\prompts\ie\user\user_prompt_aimsv3.md")

    qf_json = load_json(r"source\query_jsons\queried_aims.json")
