After applying the checks to the provided list of research questions, the final list is as follows:
...
No questions were collapsed, split, or flagged as preprocessing steps.