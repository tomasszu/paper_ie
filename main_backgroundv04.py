...
output_folder = fr"C:\Users\lenox\tomass\projects\paper_ie\outputsv4\{pdf_name}"
...
def load_json(filepath):
    try:
        with open(filepath, 'r') as f:
            ...
            json_file = json.dumps(json_file, indent=2, ensure_ascii=False)
            return json_file
...
def main():
    ...
    user_prompt_temp = load_template(r"source\prompts\ie\user\user_prompt_aims_wBackgroundv4.md")

    qf_json = load_json(r"source\query_jsons\queried_aimsv2.json")
